...
import { Video, Mic, MicOff, VideoOff, Phone, MessageSquare, Monitor, MonitorOff, Settings, Loader2 } from 'lucide-react';
...
export default function VideoCall({ doctorName, doctorSpecialty, onEndCall }: VideoCallProps) {
  ...
  return (
    <div className="fixed inset-0 bg-background z-50 flex">
        ...
        <div className="flex-1 relative bg-muted overflow-hidden">
          ...
          {screenSharing && screenStream && (
            <div className="absolute inset-0">
              ...
              />
              <Badge className="absolute top-4 left-1/2 -translate-x-1/2 bg-destructive">
      ...
      {/* Chat Panel */}
      {chatOpen && (
        <ChatPanel doctorName={doctorName} onClose={() => setChatOpen(false)} />
      )}
    </div>
  );
}
